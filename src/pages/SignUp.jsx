    ...
    <section>
      ...
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
        <div className="md:w-[67%] lg:w-[50%] mb-12 md:mb-6">
          <img src="https://images.unsplash.com/flagged/photo-1564767609342-620cb19b2357?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1073&q=80" className="w-full rounded-2xl" alt="key" />
        </div>
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          ...
          <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg">
            ...
            <p>
              <Link to="/forgot-password" className="text-blue-600 hover:text-blue-700 transition duration-200 ease-in-out ml-1">Forget password?</Link>
            </p>
            </div>
